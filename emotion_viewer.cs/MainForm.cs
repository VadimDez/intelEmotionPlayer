    ...
    // here change music
                        ...
                        if (last != EmotionLabels[epidx])
                        {
                            ...
                            this.Invoke(new myDelegate(delegate()
                            {
                                ...
                                {
                                    player.stop();
                                    player.open("C:\\Users\\Intel\\Desktop\\Porchy - Stay There(SuperFly Records).mp3");
                                    a++;
                                }
                                else
                                {
                                    player.stop();
                                    player.open("C:\\Users\\Intel\\Desktop\\Rammstain - Mein Herz Brennt.mp3");
                                    a--;
                                }
                                player.play();
                            }));
                            Console.WriteLine(EmotionLabels[epidx]);
                        }
                        last = EmotionLabels[epidx];
